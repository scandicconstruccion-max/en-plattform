    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-4 lg:px-8 py-4 lg:py-6">
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 lg:hidden" style={{ scrollbarWidth: 'none', touchAction: 'pan-x', overscrollBehavior: 'contain' }}>
            {projects.map((p) => (
              <button
                key={p.id}
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-6">
            ...
            <div className="lg:hidden -mx-4 px-4 mb-3">
              <div className="flex gap-2 overflow-x-auto pb-2" style={{ scrollbarWidth: 'none', touchAction: 'pan-x', overscrollBehavior: 'contain' }}>
